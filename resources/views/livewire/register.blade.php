...
<h2 class="font-mono text-2xl font-bold mb-6 text-center">Register</h2>
    <x-form wire:submit="save">
        <x-input label="Username" Placeholder="Username" wire:model.defer="username" icon="o-user" />
        <x-input label="Email" Placeholder="email" wire:model.defer="email" icon="o-envelope" />
